...
urlpatterns = [
    ...
    url(r'^send_email_provider/' , views.send_email_provider , name='send_email_provider'),
    url(r'^send_email_complete/' , views.send_email_complete , name='send_email_complete'),
    ...
    url(r'^scholarships/old/' ,views.old_scholarships , name='old_scholarships'),
